...
* **Kiril Vatev (Catdad):** For creating the [canvas-confetti](https://github.com/catdad/canvas-confetti) library. It was the perfect lightweight solution for adding the high-score celebration effect without bloating the application.
